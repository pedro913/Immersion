...
import { BrowserRouter, Switch, Route, Redirect, useRouteMatch, useHistory, useParams, generatePath } from 'react-router-dom';
...
function CitationProvider(_ref) {
  ...
  return /*#__PURE__*/React.createElement(CitationContext.Provider, {
    value: {
...
function RenderCite(_ref2) {
  ...
  var _useContext = useContext(CitationContext),
...
function RenderBibliography(_ref3) {
  ...
  var _useContext2 = useContext(CitationContext),
...
function AnimationEditor(_ref6) {
  ...
  })), /*#__PURE__*/React.createElement("style", null, " .formula *::selection { background: " + allColors[colorIndex] + " } "), /*#__PURE__*/React.createElement("div", {
...
function Animation(_ref7) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "preview"
  }, /*#__PURE__*/React.createElement(AutoMorph, {
...
function AutoMorph(_ref8) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "automorph",
    onClick: onClick
  }, /*#__PURE__*/React.createElement(Morph, {
    TIMING: 1.0,
    display: true,
...
function Show(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, React.Children.map(children, function (c) {
    return React.cloneElement(c, _extends({}, c.props && c.props.style ? c.props.style : {}, {
      style: realStyle
    }));
  }));
}
...
function RenderPresentation(_ref) {
  ...
  return /*#__PURE__*/React.createElement(BrowserRouter, null, /*#__PURE__*/React.createElement(Switch, null, /*#__PURE__*/React.createElement(Route, {
    ...
    exact: true,
    path: "/storage"
  }, /*#__PURE__*/React.createElement(Storage, null)), /*#__PURE__*/React.createElement(Route, {
    path: "/overview"
  }, /*#__PURE__*/React.createElement(PresentationOverview, {
    renderSlide: renderSlide,
    bibUrl: bibUrl
  }, children)), /*#__PURE__*/React.createElement(Route, {
    path: "/:slideIndex/:stepIndex",
    exact: false
  }, /*#__PURE__*/React.createElement(PresentationUI, {
    renderSlide: renderSlide,
    bibUrl: bibUrl
  }, children))));
}
...
function PresentationUI(_ref2) {
  ...
  if (slideIndex > slideInfo.length) {
    return /*#__PURE__*/React.createElement("div", null, "Too high slide number!");
  }

  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(CitationProvider, {
    citationMap: citationMap,
    bibUrl: bibUrl
  }, renderSlide({
    ...
    slides: reactSlides.map(function (slide, i) {
      return /*#__PURE__*/React.createElement(PresentationContext.Provider, {
        key: i,
        value: {
          i: i,
          slideIndex: slideIndex,
  ...
  }), /*#__PURE__*/React.createElement("div", null, slideInfo[slideIndex].presenterNotes), /*#__PURE__*/React.createElement(AnimationEditor, {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(CitationProvider, {
    ...
    return info.steps.map(function (step, stepIndex) {
      return renderSlide({
        ...
        stepIndex: stepIndex,
        numSlides: reactSlides.length,
        slides: [/*#__PURE__*/React.createElement(PresentationContext.Provider, {
          value: {
            infos: slideInfo.map(function (i) {
              return i.info;
            }),
...
function RenderSlide(_ref4) {
  ...
  var _useContext = useContext(PresentationContext),
...
function Presentation(_ref) {
  ...
  var h = 900;
  var w = 1200;
  return /*#__PURE__*/React.createElement(RenderPresentation, _extends({}, props, {
    renderSlide: function renderSlide(_ref2) {
      ...
      return /*#__PURE__*/React.createElement("div", {
      ...
      }, threeSlides), /*#__PURE__*/React.createElement("div", {
        ...
        className: "px-2 py-1"
      }, info.sectionSlide ? '\xa0' : info.section), /*#__PURE__*/React.createElement("div", {
        className: "px-2 py-1"
      }, slideIndex + 1)), /*#__PURE__*/React.createElement("div", {
...
function Slide(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(RenderSlide, _extends({
    children: children
  }, props, {
...
function SectionSlide(_ref5) {
  ...
  return /*#__PURE__*/React.createElement(Slide, {
    ...
    hideNavigation: true
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", null, section), /*#__PURE__*/React.createElement("div", {
    className: "mt-3",
    style: {
...
function TitleSlide(_ref7) {
  ...
  return /*#__PURE__*/React.createElement(Slide, {
    ...
    }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", null, names), /*#__PURE__*/React.createElement("div", null, names2)), /*#__PURE__*/React.createElement("div", null, date))));
  });
}
function TableOfContentsSlide(_ref8) {
  var header = _ref8.header;

  var _useContext2 = useContext(PresentationContext),
  ...
  return /*#__PURE__*/React.createElement(Slide, {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("ol", null, sections.map(function (section, i) {
...
function Figure(_ref10) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "p-1"
  }, /*#__PURE__*/React.createElement("b", null, "Figure:"), " ", caption));
}
function List(_ref11) {
  ...
  return /*#__PURE__*/React.createElement("ul", props, childArray.map(function (child, i) {
    return /*#__PURE__*/React.createElement(Show, {
      key: i,
...
function Item(_ref12) {
  ...
  if (name) {
    ...
    }), /*#__PURE__*/React.createElement("b", null, name + ' '), children);
  } else {
    return /*#__PURE__*/React.createElement("li", props, children);
  }
}
function Cite(_ref13) {
  var id = _ref13.id,
      hidden = _ref13.hidden;
  return /*#__PURE__*/React.createElement(RenderCite, {
    id: id,
    render: function render(_ref14) {
      var text = _ref14.text,
          number = _ref14.number;
      if (hidden) return /*#__PURE__*/React.createElement("span", null);
      return /*#__PURE__*/React.createElement("span", {
        title: text || 'Loading ...'
      }, "[", number || '??', "]");
    }
...
function BibliographySlide() {
  var stride = 4;
  return /*#__PURE__*/React.createElement(RenderBibliography, {
    render: function render(items) {
      return /*#__PURE__*/React.createElement(Slide, {
        steps: range(Math.ceil(items.length / stride))
      }, function (step) {
        if (!items) return /*#__PURE__*/React.createElement("div", null, "Loading");
...
function InlineMath(_ref) {
  var children = _ref.children;
  return /*#__PURE__*/React.createElement(Morph, {
    inline: true,
    replace: true
  }, children);
}
...
var m = function m() {
  return /*#__PURE__*/React.createElement(InlineMath, null, String.raw.apply(String, arguments));
};
var M = function M() {
  return /*#__PURE__*/React.createElement(DisplayMath, null, String.raw.apply(String, arguments));
};
