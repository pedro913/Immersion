import React, { useContext, useState, useEffect, useRef, useMemo, useCallback, useLayoutEffect, Fragment } from 'react';
...
function RenderPresentation(_ref) {
  ...
  }, React.createElement(PresentationUI, Object.assign({
    presenter: true
  }, props), children)), React.createElement(Route, {
    path: '/fullscreen/:slideIndex?/:stepIndex?'
  }, React.createElement(PresentationUI, Object.assign({
    fullscreen: true
  }, props), children)), React.createElement(Route, {
    path: '/overview'
  }, React.createElement(PresentationOverview, Object.assign({}, props), children)), React.createElement(Route, {
    path: '/:slideIndex?/:stepIndex?',
    exact: false
  }, React.createElement(PresentationUI, Object.assign({}, props), children))));
}
...
function PresentationUI(_ref2) {
  ...
  var bc = useMemo(function () {
    return new BroadcastChannel('presentation');
  }, []);
  bc.onmessage = useCallback(function (event) {
  ...
  if (slideIndex > slidesInfo.length) {
    return React.createElement("div", null, "Too high slide number!");
  }
  ...
  }, slidesInfo[slideIndex].presenterNotes) : null), React.createElement(Tab, {
...
function RenderSlide(_ref7) {
  ...
  var _ref8 = useContext(PresentationContext) || {},
...
export { AnimateSVG, DisplayMath, InlineMath, M, MObject, Morph, Notes, Portal, Show, m, range, themes, timeline };
