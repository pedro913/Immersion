import React, { useState, useEffect, useContext, useRef, useLayoutEffect, useMemo, useCallback, Fragment } from 'react';
import Citation from 'citation-js';
import memoize from 'memoizee';
import { pathParse, serializePath } from 'svg-path-parse';
import gsap$2 from 'gsap';
import { BrowserRouter, Switch, Route, useRouteMatch, useHistory, useParams, generatePath } from 'react-router-dom';
...
var CitationContext = React.createContext(null);
function CitationProvider(_ref) {
  ...
  return React.createElement(CitationContext.Provider, {
    value: {
...
function RenderCite(_ref2) {
  ...
  var _ref3 = useContext(CitationContext) || {},
...
function RenderBibliography(_ref4) {
  ...
  var _ref5 = useContext(CitationContext) || {},
...
function elementToPath(child, transform) {
  ...
  if (child.tagName === 'use') {
    ...
    if (element.tagName === 'path') {
      ...
      var _pathParse$relNormali = pathParse(path).relNormalize({
...
function AnimationEditor(_ref6) {
  ...
  var animationsIShouldShow = useMemo(function () {
  ...
  })), React.createElement("style", null, " .formula *::selection { background: " + allColors[colorIndex] + " } "), React.createElement("div", {
...
function Animation(_ref8) {
  ...
  var handleClick = useCallback(function (ev, part) {
    if (ev.button === 2) {
      var _extends3;
  ...
  }, ['start', 'end'].map(splitChars), React.createElement("div", {
    className: 'preview'
  }, React.createElement(AutoMorph, {
...
function Morph(_ref) {
  ...
  var wrapMath = useCallback(function (tex) {
  ...
  var promise = useRef(Promise.resolve());
...
function RenderPresentation(_ref) {
  ...
  if (props.embed) {
    return React.createElement(PresentationEmbedWrapper, Object.assign({}, props));
  }

  return React.createElement(BrowserRouter, null, React.createElement(Switch, null, React.createElement(Route, {
    exact: true,
    path: '/storage'
  }, React.createElement(Storage, null)), React.createElement(Route, {
    path: '/presenter/:slideIndex?/:stepIndex?'
  }, React.createElement(PresentationRouteWrapper, Object.assign({}, props, {
    mode: 'presenter'
    ...
    path: '/overview'
  }, React.createElement(PresentationOverview, Object.assign({}, props))), React.createElement(Route, {
...
function PresentationEmbedWrapper(_ref2) {
  ...
  var _useState = useState(props === null || props === void 0 ? void 0 : (_props$embedOptions = props.embedOptions) === null || _props$embedOptions === void 0 ? void 0 : _props$embedOptions.slideIndex),
      slideIndex = _useState[0],
      setSlideIndex = _useState[1];

  var _useState2 = useState(props === null || props === void 0 ? void 0 : (_props$embedOptions2 = props.embedOptions) === null || _props$embedOptions2 === void 0 ? void 0 : _props$embedOptions2.slideIndex),
      stepIndex = _useState2[0],
      setStepIndex = _useState2[1];

  return React.createElement(PresentationUI, Object.assign({}, props, {
    mode: 'embed',
...
var PresentationContext = React.createContext(null);
...
function PresentationUI(_ref4) {
  ...
  var reactSlides = React.Children.toArray(children);
  ...
  var prev = useCallback(function (dontStepButGoToPrevSlide) {
  ...
  var next = useCallback(function (dontStepButGoToNextSlide) {
  ...
  if (mode === 'presenter') {
    var slides = [[slideIndex, stepIndex], getNext(slideIndex, stepIndex)].map(function (_ref5, index) {
      ...
      return render({
        ...
        stepIndex: stepIndex,
        slidesInfo: slidesInfo,
        slides: [React.createElement(PresentationContext.Provider, {
          key: index,
          value: {
            i: slideIndex,
            slideIndex: slideIndex,
    ...
    return React.createElement("div", {
      className: 'flex'
    }, React.createElement(CitationProvider, {
      citationMap: citationMap,
      bibUrl: bibUrl
    }, React.createElement("div", {
    ...
    }, React.createElement("div", null, slides[0]), React.createElement("div", {
      className: 'text-lg'
    ...
    }, slides[1]), React.createElement("div", null, slidesInfo[slideIndex].presenterNotes)))));
  }
  ...
  if (mode === 'embed') {
    if (!(embedOptions === null || embedOptions === void 0 ? void 0 : embedOptions.render)) {
      return React.createElement("div", null, "Specify embed render function");
    }
    ...
    return embedOptions.render({
      ...
      slidesInfo: slidesInfo,
      stepIndex: stepIndex,
      presentation: React.createElement(CitationProvider, {
        citationMap: citationMap,
        bibUrl: bibUrl
      }, render({
        slideIndex: slideIndex,
  ...
  return React.createElement(CitationProvider, {
    citationMap: citationMap,
    bibUrl: bibUrl
  }, React.createElement("div", {
  ...
  }, slidesInfo[slideIndex].presenterNotes ? React.createElement("div", {
    className: 'text-sm p-2'
  }, slidesInfo[slideIndex].presenterNotes) : React.createElement("div", {
    className: 'text-gray-500 text-sm m-2 text-center'
  }, "no presenter notes")), React.createElement(Tab, {
    label: 'Animation editor'
  }, slidesInfo[slideIndex].animations.length ? React.createElement(AnimationEditor, {
...
function Tab(_ref7) {
  ...
  }, label), show && React.createElement("div", null, children));
}
...
function PresentationOverview(_ref8) {
  ...
  return React.createElement("div", null, React.createElement(CitationProvider, {
    citationMap: citationMap,
    bibUrl: bibUrl
...
function RenderSlide(_ref9) {
  ...
  var _ref10 = useContext(PresentationContext) || {},
...
function Show(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.Children.map(children, function (c) {
...
function Presentation(props) {
  var h = 900;
  var w = 1200;
  return React.createElement(RenderPresentation, Object.assign({}, props, {
    render: function render(_ref) {
      ...
      return React.createElement("div", {
        ...
        className: 'px-2 py-1'
      }, info.sectionSlide ? '\xa0' : info.section), React.createElement("div", {
        className: 'px-2 py-1'
      }, slideIndex + 1)), React.createElement("div", {
...
function Slide(_ref2) {
  ...
  return React.createElement(RenderSlide, Object.assign({
    children: children
  }, props, {
    render: function render(_ref3) {
      ...
      }, info.header && React.createElement("div", {
...
function SectionSlide(_ref4) {
  ...
  var _ref5 = useContext(PresentationContext) || {},
      _ref5$i = _ref5.i,
  ...
  return React.createElement(Slide, {
    ...
    hideNavigation: true
  }, React.createElement("div", null, React.createElement("div", null, section), React.createElement("div", {
    className: 'mt-3',
    style: {
...
function TitleSlide(_ref7) {
  ...
  return React.createElement(Slide, {
    ...
    }, title))), React.createElement(Show, {
      when: step > 1
    }, React.createElement("div", {
      className: 'text-sm flex items-end justify-between'
    }, React.createElement("div", null, React.createElement("div", null, names), React.createElement("div", null, names2)), React.createElement("div", null, date))), children);
  });
}
function TableOfContentsSlide(_ref8) {
  ...
  var _ref9 = useContext(PresentationContext) || {},
  ...
  return React.createElement(Slide, {
    ...
    return React.createElement(React.Fragment, null, React.createElement("ol", null, sections.map(function (section, i) {
...
function Figure(_ref11) {
  ...
  return React.createElement("div", {
    ...
    className: 'flex-grow'
  }, children), caption && React.createElement("div", {
    className: 'p-1'
  }, React.createElement("b", null, "Figure:"), " ", caption));
}
function List(_ref12) {
  ...
  return React.createElement("ul", Object.assign({}, props), childArray.map(function (child, i) {
    return React.createElement(Show, {
      key: i,
...
function Item(_ref13) {
  ...
  if (name) {
    ...
    }), React.createElement("b", null, name + ' '), children);
  } else {
...
function Cite(_ref14) {
  ...
  return React.createElement(RenderCite, {
    id: id,
    render: function render(_ref15) {
      var text = _ref15.text,
          number = _ref15.number;
      if (hidden) return React.createElement("span", null);
      return React.createElement("span", {
        title: text || 'Loading ...'
      }, "[", number || '??', "]");
    }
...
function BibliographySlide() {
  var stride = 4;
  return React.createElement(RenderBibliography, {
    render: function render(items) {
      return React.createElement(Slide, {
        steps: range(Math.ceil(items.length / stride))
      }, function (step) {
        if (!items) return React.createElement("div", null, "Loading");
  ...
  return React.createElement(RenderSlide, Object.assign({
    ...
    render: function render(_ref3) {
      ...
      return React.createElement("div", {
        ...
        return e === '||' ? React.createElement("br", null) : e;
      }) : info.header), React.createElement("div", {
        className: "flex-grow p-6 " + className,
        style: slideStyle
      }, children)));
...
function OverviewSlide(_ref4) {
  ...
  return React.createElement(Slide$1, {
    hideNavigation: true,
    ...
    }, s.section), React.createElement("br", null), React.createElement("span", {
...
function InlineMath(_ref) {
  ...
  return React.createElement(Morph, Object.assign({
    inline: true,
    replace: true
  }, props), children);
}
...
var m = function m(template) {
  ...
  return React.createElement(InlineMath, null, String.raw.apply(String, [template].concat(subtitutions)));
};
var M = function M(template) {
  ...
  return React.createElement(DisplayMath, null, String.raw.apply(String, [template].concat(subtitutions)));
};
...
function Portal(_ref2) {
  ...
  var context = useContext(PresentationContext);
...
export { AnimateSVG, CitationContext, DisplayMath, InlineMath, M, MObject, Morph, Notes, Portal, PresentationContext, RenderPresentation, Show, _internalTimeline, formulas, getSlidesInfo, m, range, themes, timeline };
